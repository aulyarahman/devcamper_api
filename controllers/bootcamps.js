...
exports.createBootcamp = asyncHandler(async (req, res, next) => {
    ...
    // if user is not an admin, they can only one bootcamp
    if(publishedBootcamp && req.user.role !== 'admin') {
        return next(new ErrorResponse(`The user with ID ${req.user.id} has already publis bootcamp`, 400))
    }
...
exports.getBotcampsInRadius = asyncHandler(async (req, res, next) => {
  const { zipcode, distance } = req.params;
    ...
    //   get latitude dan lan from geocoder
